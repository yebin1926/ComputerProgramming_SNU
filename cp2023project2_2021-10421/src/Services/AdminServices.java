...
public class AdminServices implements ServiceInterface{
    //TODO class responsible for search-related commands for admin
    ...
    public ArrayList<String> run(String path, Map<String, String> userIdPw, Map<String, Integer> searchFreq){
        ...
        switch(command){
            ...
            case "/data/load_hot":
                ...
                break;
            case "/data/load_acc":
                returnList = Data.loadAcc();
                break;
            case "/data/load_log":
                returnList = Data.loadLog();
                break;
            default:
                break;
        }
